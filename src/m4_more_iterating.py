...
def sum_sequence(sequence):
    ...
    for k in range(len(sequence)):
        sum_numbers = sum_numbers + sequence[k]
    return sum_numbers
...
def run_test_count_items_bigger_than():
   ...
   # Test 9:
    sequence = [10000, 800, 32, 7000, -32, 44444,99999999]
    threshold = 2300
    expected = 4
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [34,23,1,3,4,65,-1000,7**2]
    threshold = 5
    expected = 4
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def count_items_bigger_than(numbers, threshold):
    ...
    # ------------------------------------------------------------------
    numbers_greater_than_threshold = 0
    for k in range(len(numbers)):
        if numbers[k]>threshold:
            numbers_greater_than_threshold = numbers_greater_than_threshold +1
    return numbers_greater_than_threshold
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 4
    actual = count_positive_sines([32,14,15,13,12])
    print()
...
def count_positive_sines(numbers):
    ...
    for k in range(len(numbers)):
        if math.sin(numbers[k])>0:
            positive_sines = positive_sines +1
    return positive_sines
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 167
    actual = sum_first_n([32,12,123,13,12,65,32,89,54], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 63
    actual = sum_first_n([400,42,-400,21,356], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
...
def sum_first_n(numbers, n):
    ...
    sum_of_n_numbers = 0
    for k in range(n):
        sum_of_n_numbers = sum_of_n_numbers + numbers[k]
