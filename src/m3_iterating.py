...
def run_test_count_negatives():
  ...
  # Test 6:
    expected = 3
    actual = count_negatives([-10,4,5,32,-.5,1,-2.3])
    print()
    ...
    # Test 7:
    expected = 2
    actual = count_negatives([32,1,2,3,4,123,-1000,-5])
    print()
...
def run_test_count_short_ones():
    ...
    # Test 8:
    expected = 3
    seq = [[49,37,123,76], ['hi', 'hello'], ['open','close'], []]
    actual = count_short_ones(seq)
    print()
    ...
    # Test 9:
    expected = 3
    seq = [[1, 1], [1, 43, 29,41], [0,31], ['yes','no']]
    actual = count_short_ones(seq)
    print()
...
def count_short_ones(seq_of_lists):
    ...
    #   Note that you should write its TEST function first (above).
    # ------------------------------------------------------------------
    total_with_less_than_three = 0
    for k in range (len(seq_of_lists)):
        if len(seq_of_lists[k])<3:
            total_with_less_than_three = total_with_less_than_three + 1
    return total_with_less_than_three
